...
```powershell
python .\.codex\skills\masked-imagegen-protection\scripts\align_gray_regions.py --original .\original.png --generated .\assets\edited-v1-raw.png --mask .\work\mask\original-manual-api-mask.png --match-tones --match-erode 4 --feather 1.0 --auto-out .\assets\edited-v1-auto-aligned.png
```

命令 3：读取联通块位移参数并回盖

```powershell
python .\.codex\skills\masked-imagegen-protection\scripts\apply_protection_overlay.py --original .\original.png --generated .\assets\edited-v1-raw.png --mask .\work\mask\original-manual-api-mask.png --region-transforms .\work\mask\original-region-transforms.json --match-tones --match-threshold 32 --match-erode 4 --feather 1.0 --out .\assets\edited-v1.png
```
...
```powershell
python .\.codex\skills\masked-imagegen-protection\scripts\apply_protection_overlay.py --original .\original.png --generated .\generated.png --mask .\work\mask\original-manual-api-mask.png --out .\assets\edited-v1.png
```
...
```powershell
python .\.codex\skills\masked-imagegen-protection\scripts\apply_protection_overlay.py --original .\original.png --generated .\generated.png --mask .\work\mask\original-manual-api-mask.png --match-tones --match-erode 4 --feather 1.8 --out .\assets\edited-v2.png
```

如果灰区边界有一圈发亮、发硬或接缝感明显，可以再加接缝带局部模糊：

```powershell
python .\.codex\skills\masked-imagegen-protection\scripts\apply_protection_overlay.py --original .\original.png --generated .\generated.png --mask .\work\mask\original-manual-api-mask.png --match-tones --match-erode 4 --feather 1.0 --seam-blur 1.6 --seam-width 3 --out .\assets\edited-v3.png
```
